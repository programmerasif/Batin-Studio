...
const SixSecModal = ({updateData, setUpdateData}) => {
    ...
    //     }
    //     fetch(`http://localhost:5001/sixSecModal/${updateData?._id}`, {
    //         method: 'PATCH',
    ...
    return (
        <div>
            ...
            {/* <dialog id="SixSecModal" className="SixSecModal-style z-30">
                ...
                <h2 className='bg-white text-black'>{updateData?.title}</h2>


                <div onClick={()=>setUpdateData({})} className="modal-action absolute top-0 right-2">
                        <form method="dialog">
